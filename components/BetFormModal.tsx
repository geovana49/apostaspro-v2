            ...
            (async () => {
                ...
                try {
                    ...
                    if (saveAsGain) {
                        ...
                        const gainData = {
                            id: betId, amount: profit,
                            date: formData.date.includes('T') ? formData.date : `${formData.date}T12:00:00.000Z`,
                            status: gainStatus, origin: formData.promotionType || 'Aposta Esportiva',
                            bookmakerId: formData.mainBookmakerId, game: formData.event,
                            notes: formData.notes || '', photos: photoUrls, coverages: formData.coverages
                        };
                        const gainToSave = JSON.parse(JSON.stringify(gainData, (k, v) => v === undefined ? null : v));
                        ...
                        const betToSave = JSON.parse(JSON.stringify(rawBet, (k, v) => v === undefined ? null : v));
