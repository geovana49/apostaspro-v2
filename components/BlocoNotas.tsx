    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <Card className="bg-gradient-to-br from-[#1a1f35] to-[#0d1425] border-gray-800/50 relative overflow-hidden pb-4">
                {/* Header Container - Reorganized Elements */}
                <div className="flex flex-col p-6 pt-20 pb-8 relative z-20">
                    ...
                    <div className="flex justify-center w-full">
                        <button
                            ...
                            className="p-1 sm:p-2 rounded-full text-gray-500 hover:text-white hover:bg-white/5 transition-all bg-white/5 border border-white/5"
                        >
