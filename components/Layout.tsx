              ...
              >
                ...
                `}>
                  ...
                  {item.id === Page.NOTES && notesCount > 0 && (
                    <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center w-[18px] h-[18px] rounded-full bg-[#ffff00] text-[#000000] text-[10px] font-black shadow-[0_0_15px_rgba(255,255,0,0.6)] border border-yellow-400/30 animate-pulse animate-in zoom-in duration-300">
                      {notesCount}
                    </span>
                  )}
                </span>
