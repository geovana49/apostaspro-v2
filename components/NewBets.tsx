                        ...
                        {filteredBets.map(bet => {
                            ...
                            return (
                                <Card
                                    ...
                                    className="group relative overflow-hidden bg-[#151b2e]/40 border-white/5 hover:border-primary/30 transition-all duration-300 cursor-pointer active:scale-[0.99] p-4 md:p-6 min-h-[130px] touch-manipulation"
                                >
                                    <div
                                        ...
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col justify-center gap-0.5">
                                                    ...
                                                    <span className="text-[10px] sm:text-[11px] text-gray-400 font-bold tracking-wider leading-none">
                                                        ODD {cov.odd.toFixed(2)}
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="text-right shrink-0">
