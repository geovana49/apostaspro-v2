                            ...
                            return (
                                <Card
                                    ...
                                    className={`
                                        ...
                                        ${viewMode === 'grid' ? 'p-5 pl-5 flex flex-col' : 'p-4 pl-5 flex flex-row items-center justify-between min-h-[90px]'}
                                    `}
                                >
                                    <div
                                    ...
                                    <div className={`flex items-center gap-5 ${viewMode === 'grid' ? 'mb-4' : 'flex-[1.2] min-w-[300px] mr-8 my-auto pl-1'}`}>
