                            ...
                            return (
                                <Card
                                    ...
                                    className={`
                                        ...
                                        ${viewMode === 'grid' ? 'p-5 pl-14 flex flex-col' : 'p-4 pl-6 flex flex-row items-center justify-between min-h-[110px]'}
                                    `}
                                >
                                    <div
                                    ...
                                    <div className={`flex items-center gap-5 ${viewMode === 'grid' ? 'mb-4' : 'flex-[1.2] min-w-[300px] mr-8'}`}>
                                        <div className="w-10 h-10 ml-14 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shrink-0">
                                            {bookie?.logo ? (
