                            ...
                            return (
                                <Card
                                    ...
                                    className={`
                                        ...
                                        ${viewMode === 'grid' ? 'p-5 pl-20 flex flex-col gap-10' : 'p-4 pl-28 flex flex-row items-center justify-between min-h-[140px]'}
                                    `}
                                >
                                    <div
                                    ...
                                    {/* Event Info - forced margin to clear sidebar bar */}
                                    <div className={`flex items-center gap-5 ${viewMode === 'grid' ? 'mb-8' : 'flex-[1.2] min-w-[300px] mr-8'}`}>
                                        <div className="w-12 h-12 ml-10 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shrink-0">
                                            {bookie?.logo ? (
                                    ...
                                    <div className={`
                                        flex items-center 
                                        ${viewMode === 'list' ? 'flex-[3] justify-between ml-10 pl-10 border-l border-white/5' : 'flex-col gap-10 mt-8'}
                                    `}>
                                        {/* Financials Row */}
