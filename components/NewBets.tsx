                        ...
                        {filteredBets.map(bet => {
                            ...
                            return (
                                <Card
                                    ...
                                    className="group relative overflow-hidden bg-[#151b2e]/40 border-white/5 hover:border-primary/30 transition-all duration-300 cursor-pointer active:scale-[0.99] p-4 pl-20 md:p-6 md:pl-28 min-h-[130px]"
                                >
                                    <div
